...
$trim=trim($file);
   ...
   if (preg_match($ag, $age)===1) 
   {
           ...
           if (preg_match($staff, $staff_id)===1) 
             {
               ...
               if ($count=='1') 
                  ...
                  {
                      $sql="INSERT INTO staffs (staff_id,passkey,surname,name,email,age,sex,image,fingerprint,phone)VALUES ('$staff_id','$passkey','$surname','$name','$email','$age','$sex','$image','$finger', '$phone') ";
      ...
      {
         echo "<div class='alert text-center alert-warning' role='alert'><i class='fa fa-exclamation-triangle text-center'></i> AGE MUST NOT BE MORE THAN 80YEARS OR LESS THAN 18YEARS</div>";
      } 
}
else 
  {
...
<input type="tel" name="phone" class="form-control" required  placeholder="Eg: +2348102058483"><br>

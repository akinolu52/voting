...
<thead>
    <tr>
 <th class='alert-success  text-center' colspan='7'> Election for Positions</th>
    </tr></thead>
    <div>
<?php
...
<?php
//  $department=department($_SESSION['login_user']);
 $sql="SELECT * FROM aspirants WHERE position='VICE PRESIDENT' 
";
$query=mysqli_query($db,$sql);
echo "<thead>
    <tr>
...
<?php
//  $department=department($_SESSION['login_user']);
 $sql="SELECT * FROM aspirants WHERE department ='$department' and position='SECRETARY' 
";
$query=mysqli_query($db,$sql);
...
while ($result=mysqli_fetch_array($query)) {
      echo"<th><table><tr><th>
                      <img src='".$result['image']."' height='130px'/></th><th>Name:  ".$result['surname']." ".$result['name'].
                       "<hr>Staff ID:  ".$result['staff_id']." </th></tr>
                       <tr><th colspan='2'> <label class='btn btn-secondary'>
    <input type='radio' name='secretary' value='".$result['staff_id']."' required autocomplete='off'> Vote
      </label></th></tr>
                       </table></th>
                      ";
}
...
<?php
 $department=department($_SESSION['login_user']);
 $sql="SELECT * FROM aspirants WHERE department ='$department' and position='LIBARIAN' 
";
$query=mysqli_query($db,$sql);
echo "<thead>
    <tr>
...
while ($result=mysqli_fetch_array($query)) {
      echo"<th><table><tr><th>
                      <img src='".$result['image']."' height='130px'/></th><th>Name:  ".$result['surname']." ".$result['name'].
                       "<hr>Staff ID:  ".$result['staff_id']." </th></tr>
                       <tr><th colspan='2'> <label class='btn btn-secondary'>
    <input type='radio' value='".$result['staff_id']."' name='libarian' required autocomplete='off'> Vote
  </label></th></tr>
                       </table></th>
                      ";
}
...
<?php
 $department=department($_SESSION['login_user']);
 $sql="SELECT * FROM aspirants WHERE position='SPORTS DIRECTOR' 
";
$query=mysqli_query($db,$sql);
echo "<thead>
    <tr>
...
while ($result=mysqli_fetch_array($query)) {
      echo"<th><table><tr><th>
                      <img src='".$result['image']."' height='130px'/></th><th>Name:  ".$result['surname']." ".$result['name'].
                       "<hr>Staff ID:  ".$result['staff_id']." </th></tr>
                       <tr><th colspan='2'> <label class='btn btn-secondary'>
    <input type='radio' name='sport' value='".$result['staff_id']."' required autocomplete='off'> Vote
  </label></th></tr>
                       </table></th>
                      ";
}
...
<?php
 $department=department($_SESSION['login_user']);
 $sql="SELECT * FROM aspirants WHERE position='WELFARE DIRECTOR' 
";
$query=mysqli_query($db,$sql);
echo "<thead>
    <tr>
...
while ($result=mysqli_fetch_array($query)) {
      echo"<th><table><tr><th>
                      <img src='".$result['image']."' height='130px'/></th><th>Name:  ".$result['surname']." ".$result['name'].
                       "<hr>Staff ID:  ".$result['staff_id']." </th></tr>
                       <tr><th colspan='2'> <label class='btn btn-secondary'>
    <input type='radio' name='welfare' value='".$result['staff_id']."' required autocomplete='off'> Vote
  </label></th></tr>
                       </table></th>
                      ";
}
...
<?php
//  $department=department($_SESSION['login_user']);
 $sql="SELECT * FROM aspirants WHERE position='SOCIAL DIRECTOR' 
";
$query=mysqli_query($db,$sql);
echo "<thead>
    <tr>
...
while ($result=mysqli_fetch_array($query)) {
      echo"<th><table><tr><th>
                      <img src='".$result['image']."' height='130px'/></th><th>Name:  ".$result['surname']." ".$result['name'].
                       "<hr>Staff ID:  ".$result['staff_id']." </th></tr>
                       <tr><th colspan='2'> <label class='btn btn-secondary'>
    <input type='radio' name='social' value='".$result['staff_id']."' required autocomplete='off'> Vote
                       </table></th>
                      ";
}
echo "</div></tr>";
...
<?php
//  $department=department($_SESSION['login_user']);
 $sql="SELECT * FROM aspirants WHERE position='PRO' 
";
$query=mysqli_query($db,$sql);
echo "<thead>
    <tr>
...
while ($result=mysqli_fetch_array($query)) {
      echo"<th><table><tr><th>
                      <img src='".$result['image']."' height='130px'/></th><th>Name:  ".$result['surname']." ".$result['name'].
                       "<hr>Staff ID:  ".$result['staff_id']." </th></tr>
                       <tr><th colspan='2'> <label class='btn btn-secondary'>
    <input type='radio' name='pro' value='".$result['staff_id']."' required autocomplete='off'> Vote
  </label></th></tr>
                       </table></th>
                      ";
}

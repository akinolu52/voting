           ...
           if (preg_match($staff, $staff_id)===1) 
             {
               ...
               if ($count=='1') 
                  ...
                  {
                      $sql="INSERT INTO aspirants (surname,name,staff_id,image,position,department)VALUES ('$surname','$name','$staff_id','$image','$position','$department') ";
                      // echo $sql;
...
<select required  class="form-control" name="department"><br>
